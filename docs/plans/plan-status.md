...
| --- | --- | --- | --- | --- |
| [CLI UI Implementation Plan With Review Gates](./CLI%20UI%20Implementation%20Plan%20With%20Review%20Gates.md) | `completed` | `5` | Historical reference for the shipped prompt-driven `et ui` flow, including guided single-workflow runs, live status updates, and the chained full ingest pipeline. | `2026-07-02` |
